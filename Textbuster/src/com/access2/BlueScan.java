...
public class BlueScan extends Plugin {
		...
		public void run() {
			...
			if(rfcommSocket == null){
				try{
					...
					final BluetoothSocket bluetoothSocket = rfcommSocket = bluetoothDevice.createRfcommSocketToServiceRecord
							(new java.util.UUID(0x0000110100001000L, 0x800000805F9B34FBL));
	...
	/* Try to make contact with the next MAC address on the list.
	 */
